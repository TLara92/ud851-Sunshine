...
public class SunshineSyncUtils {
    ...
    private static final int ACTION_SYNC_SUNSHINE_HOURS =4;
    private static final int ACTION_SYNC_SUNSHINE_SECONDS = ((int) TimeUnit.HOURS.toSeconds(ACTION_SYNC_SUNSHINE_HOURS));
    private static final int SYNC_FLEXTIME_SECONDS = ACTION_SYNC_SUNSHINE_SECONDS / 4;

    private static boolean sInitialized;

private static final String ACTION_SYNC_TAG = "sync=weather";
...
static void scheduleFirebaseJobDispatcher(@NonNull final Context context) {
    ...
    Job syncSunshineJob = dispatcher.newJobBuilder()
            ...
            .setTag(ACTION_SYNC_TAG)
             .setConstraints(Constraint.ON_ANY_NETWORK)
             .setLifetime(Lifetime.FOREVER)
             .setRecurring(true)
             .setTrigger(Trigger.executionWindow(
                      ACTION_SYNC_SUNSHINE_SECONDS,
                      ACTION_SYNC_SUNSHINE_SECONDS + SYNC_FLEXTIME_SECONDS))
