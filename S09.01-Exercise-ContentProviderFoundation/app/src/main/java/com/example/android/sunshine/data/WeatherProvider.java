...
public class WeatherProvider extends ContentProvider {
    ...
    public  static UriMatcher buildUriMatcher(){
        ...
        final String authrity = WeatherContract.CONTENT_AUTHORITY;
        matcher.addURI(authrity,WeatherContract.PATH_WEATHER,CODE_WEATHER);
        matcher.addURI(authrity,WeatherContract.PATH_WEATHER + "/#", CODE_WEATHER_WITH_DATE);
        return matcher;
}
    @Override
