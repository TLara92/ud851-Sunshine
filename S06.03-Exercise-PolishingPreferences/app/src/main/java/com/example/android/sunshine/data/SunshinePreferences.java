...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
       /** This will be implemented in a future lesson **/
        ...
        String locationValue = context.getString(R.string.pref_location_default);
        return sharedPreferences.getString(locationKey,locationValue);
    }
    ...
    public static boolean isMetric(Context context) {
       /** This will be implemented in a future lesson **/
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        String unitsKey = context.getString(R.string.pref_location_key);
        String unitsValue = context.getString(R.string.pref_location_default);
        String units = sharedPreferences.getString(unitsKey,unitsValue);
